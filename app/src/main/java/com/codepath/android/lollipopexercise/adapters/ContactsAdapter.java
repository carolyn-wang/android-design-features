            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (contact != null) {
                        ...
                        Intent contactDetails = new Intent(mContext, DetailsActivity.class);
                        contactDetails.putExtra(DetailsActivity.EXTRA_CONTACT, contact);
                        mContext.startActivity(contactDetails);
                    }
                }
            });
        }
